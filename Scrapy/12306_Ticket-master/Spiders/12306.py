...
class Leftquery(object):
    ...
    def __init__(self):
        ...
        self.headers = {
            ...
            'Cookie' : 'JSESSIONID=013D1E03F08D4837D9D0E7C102A8E044; tk=gpPs0byKnNe5y9Jd8N3FRJgfXf4MLOAoE5ICVAsdw1w0; BIGipServerotn=1072693770.24610.0000; RAIL_EXPIRATION=1583934174749; RAIL_DEVICEID=pznPRjxBCnvzvTXAWWF-6mFTAr5kJsJS2SXn9x_P0he0DGLDxYSKbxGDMZ5IBj_nnNi0ReqFKRbQ5QphwpG1aaeTn1ODuGLQtFVlUjzv1d0mpbnftxDQb1yv-a4vp-Jt5vKDGtsYSbKpkEMjY_V6giz0KTpBO8gR; BIGipServerpool_passport=384631306.50215.0000; route=9036359bb8a8a461c164a04f8f50b252; _jc_save_fromStation=%u5317%u4EAC%2CBJP; _jc_save_toStation=%u4E0A%u6D77%2CSHH; _jc_save_fromDate=2020-04-01; _jc_save_toDate=2020-03-08; _jc_save_wfdc_flag=dc'}
    ...
    def query(self, from_station, to_station, date):
        ...
        #"https://kyfw.12306.cn/otn/leftTicket/query?leftTicketDTO.train_date=2020-04-01&leftTicketDTO.from_station=BJP&leftTicketDTO.to_station=SHH&purpose_codes=ADULT"
